...
<div class="row">
    ...
    <div class="row">
        <h3>Sélectionner le stage à modifier</h3>
        <form method="get" action="Controleur">
            <input type="hidden" name="action" value="modifierStage"  id="action"/>
            <select name="selectStage">
    ...
    <c:if test="${stage.id > 0}">
        ...
        <form method="post" action="Controleur" onsubmit="return verif();">
            ...
            <input type="hidden" name="action" value="ajouterModificationStage" />
